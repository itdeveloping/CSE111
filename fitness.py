...
def main():
    ...
    length_in_centimeters = cm_from_in (height)

    bmi = body_mass_index (mass_in_kg, length_in_centimeters)
    bmr = basal_metabolic_rate (gender, mass_in_kg, length_in_centimeters, age)

    # Print the results for the user to see.
    print (f"Age (years): {age}")
    print (f"Weight (kg): {mass_in_kg:.2f}")
    print (f"Height (cm): {length_in_centimeters:.1f}")
